import { type OptionsType, defaultOptions } from './options';
...
export type AutoplayType = CreatePluginType<
  {
    ...
    setOptions: (options: Partial<AutoplayOptionsType>) => void;
    next: () => void;
  },
  OptionsType
>;
...
function Autoplay(userOptions: AutoplayOptionsType = {}): AutoplayType {
  ...
  function setOptions(newOptions: Partial<AutoplayOptionsType>): void {
